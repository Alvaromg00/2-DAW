...
//Método toDiv, creo un div y lo asigno a la variable nuevoDiv, le añado la clase entrada y la estructura html con el titulo y el contenido
    toDiv(){
    ...
    `;
//Pongo el botón usuarios a la escucha, asigno su div a usuarioDiv y su span a nombreUsuarioSpan
