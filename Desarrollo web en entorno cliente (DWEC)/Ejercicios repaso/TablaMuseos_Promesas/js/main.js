...
boton.addEventListener('click', function () {
    if(evalua==false){
        function pintarInfoMuseo(objetoMuseo) {
            ...
            contenido.innerHTML = `
                <td style="border: 1px solid black;">${objetoMuseo.rdfs_label.value}</td>
                <td style="border: 1px solid black;">${objetoMuseo.geo_lat.value}</td>
                <td style="border: 1px solid black;">${objetoMuseo.geo_long.value}</td>
                <td style="border: 1px solid black;">${objetoMuseo.schema_url ? objetoMuseo.schema_url.value : '--'}</td>
            `;
            return contenido;
        }
